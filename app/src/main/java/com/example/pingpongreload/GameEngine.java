package com.example.pingpongreload;
...
public class GameEngine extends SurfaceView implements Runnable {
    ...
    final int DISTANCE_FROM_BOTTOM = 10;
    ...
    public GameEngine(Context context, int w, int h) {
        ...
        racketPosition.x = (this.screenHeight / 2) - PADDLE_WIDTH;   // left
        racketPosition.y = (this.screenWidth - DISTANCE_FROM_BOTTOM - PADDLE_HEIGHT);                // top
    ...
    public void redrawSprites() {
        if (this.holder.getSurface().isValid()) {
            ...
            // draw the paddle
            int paddleLeft = racketPosition.y;
            int paddleTop = racketPosition.x;
            int paddleRight = racketPosition.y + 2*PADDLE_WIDTH;
            int paddleBottom = racketPosition.x + PADDLE_HEIGHT;
